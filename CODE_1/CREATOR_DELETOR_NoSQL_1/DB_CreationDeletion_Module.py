...
##########################################################################################################################################
# Function: Delete a Collection from a MongoDB Database.
##########################################################################################################################################
def delete_collection(client, db_name, collection_name):
    """
    Delete a specific collection in a MongoDB database.
    ...
    if db_name in client.list_database_names():
        ...
        if collection_name in db.list_collection_names():
            ...
            print(f"Collection '{collection_name}' in database '{db_name}' has been deleted.")
        else:

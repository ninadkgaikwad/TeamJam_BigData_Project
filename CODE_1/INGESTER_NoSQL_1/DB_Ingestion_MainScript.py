...
base_path = "C:\\Users\\ninad\OneDrive - Washington State University (email.wsu.edu)\\24_CPTS415_TeamJam\\Data\\RawData\\Uncompressed"
...
for idx in selected_indices:
    if 0 <= idx < len(collections):
        ...
        avg_time = helper.populate_sensor_collection1(db_name, collection_name, base_path, mongo_uri, chunk_size=10000)

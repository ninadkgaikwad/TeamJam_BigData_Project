...
@app.callback(    
    ...
    State(component_id = 'Sensor_Name_DropDown', component_property = 'value'),
    prevent_initial_call = False)
def SensorPosition_DropDown_Interaction(Sensor_Position_DropDown_Value, Recording_ID_DropDown_Value, Sensor_Name_DropDown_Value):
...
@app.callback(
    ...
    Output(component_id='Subfield_DropDown', component_property='columns'),
    ...
    State(component_id='Recording_ID_DropDown', component_property='value'),
    State(component_id='Sensor_Name_DropDown', component_property='value'),
    State(component_id='Start_Datetime_Input', component_property='children'),
    State(component_id='End_Datetime_Input', component_property='children'),
    prevent_initial_call=False
)
def Statistics_Button_Interaction(N_Clicks, Sensor_Field_DropDown_Value, Sensor_Position_DropDown_Value, Recording_ID_DropDown_Value, Sensor_Name_DropDown_Value, Start_Datetime_Input, End_Datetime_Input):
    ...
    Queried_Data_Statistics_DF = AppFuncs.calculate_sensor_statistics(Queried_Data_DF, SubField_List, nested_field=None, output_csv=None)

    # Getting DataTable_Data, DataTable_Columns
    DataTable_Data = Queried_Data_Statistics_DF.to_dict('records')

    DataTable_Columns = [{"name": i, "id": i} for i in Queried_Data_Statistics_DF.columns]
